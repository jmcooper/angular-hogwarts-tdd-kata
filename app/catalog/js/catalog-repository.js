   ...
   return {
       getCatalog: function() {
           return [
               ...
               {id: "DDA302-10", name: "Defense Against the Dark Arts", startTime: new Date(0,0,0,10), professor: "Severus Snape", credits: 4 },
               {id: "DDA302-13", name: "Defense Against the Dark Arts", startTime: new Date(0,0,0,13), professor: " Quirinus Quirrell", credits: 4 },
